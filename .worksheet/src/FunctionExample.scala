...
object FunctionExample {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(70); 
  ...
  printName("(", firstname = "sam", lastname = "naru");$skip(158); 
